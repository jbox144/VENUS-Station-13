...
/obj/item/alienartifact
	...
	icon = 'modular_venus/icons/obj/artifact.dmi'
	icon_state = "artifact"
...
/area/tear_in_reality
	...
	area_flags = UNIQUE_AREA | HIDDEN_AREA | NOTELEPORT
...
// Gravity Well
//===================
/* Disabled due to code architecture differences
...
// Light Breaker
//===================
/* Disabled due to code architecture differences (beestation handles lighteater on the object, but here, the lighteater is responsible for that)
