...
/obj/machinery/computer/shuttle/custom_shuttle/ui_static_data(mob/user)
	var/list/data = ..()
	calculateStats()
	data["display_fuel"] = TRUE
	return data

/obj/machinery/computer/shuttle/custom_shuttle/ui_data(mob/user)
	var/list/data = ..()
	data["fuel"] = get_fuel()
...
/obj/machinery/computer/shuttle/custom_shuttle/launch_shuttle()
	calculateStats()
	if(calculated_acceleration < 1)
...
/obj/machinery/computer/shuttle/custom_shuttle/proc/consume_fuel(var/multiplier = 1)
	//Reset stats
	calculated_dforce = 0
...
/obj/machinery/computer/shuttle/custom_shuttle/proc/check_stranded()
...
/obj/machinery/computer/shuttle/custom_shuttle/proc/get_fuel()
	var/amount = 0
	for(var/obj/machinery/shuttle/engine/E as() in shuttle_engines)
		var/obj/machinery/atmospherics/components/unary/shuttle/heater/shuttle_heater = E.attached_heater?.resolve()
		if(!shuttle_heater)
...
/obj/machinery/computer/shuttle/custom_shuttle/proc/calculateStats(var/useFuel = FALSE)
...
/obj/machinery/computer/shuttle/custom_shuttle/connect_to_shuttle(obj/docking_port/mobile/port, obj/docking_port/stationary/dock, idnum, override=FALSE)
